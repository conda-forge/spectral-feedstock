...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spectral-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3546&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spectral-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spectral` can be installed with:

```
conda install spectral
```

It is possible to list all of the versions of `spectral` available on your platform with:
